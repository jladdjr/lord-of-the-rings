...
newspaper = Item("The Shire Newspaper", "Mostly tabloids... about hobbits", 1, 1)
...
phialOfGaladriel = Item("Phial of Galadriel", "\"May it be a light for you in dark places\"", 0, 0)
...
negativeThinking = Charm("Negative Thinking", "Not something you want", 10, 0, -10, -10, -10)
...
executorSword = Weapon("Executor Sword", "A gift from Prince Imrahil", 3, 15, 4)
windbeam = Charm("Windbeam", "The Horn of Elendil", 1, 1, 1, 1, 1)
towerOfEchelionItems = {"Denethor": [palatir, windbeam], "Prince Imrahil": executorSword}

#Beach
draagz = Item("Draagz", "Bad for health", 15, 1)
vodka = Potion("Vodka", "From the Gondorian heartland", 10, 5, 10)
flowersAndTrinkets = Charm("Flowers And Trinkets", "Massive mental health bonuses", 10, 5, 10, 1, 1)
beachItems = {"Gondorian bro #3": [draagz, vodka], "Gondorian bro #2": flowersAndTrinkets}

#Isenguard
keysOfOrthanc = Item("Keys to Orthanc", "Two gigantic black keys needed to gain entry to the Tower of Orthanc", 1, 1)
...
herugrim = Weapon("Herugrim", "Theoden's sword. Will attract negative attention", 10, 10, 20)
