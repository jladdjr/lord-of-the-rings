...
class Morannon(UniquePlace):
	...
	"""
        ...
        monster = BlackGate(constants.MONSTER_STATS[BlackGate])
    ...
    def enter(self, player):
        ...
        print ""
        print "\"Morannon\" refers to the Black Gate of Mordor, an enormous fortress used to defend Mordor from armies."
    ...
    def _victorySequence(self, player):
        print "You have taken the Black Gate and secured the north-western route into Mordor!"
        raw_input("Press enter to continue. ")
        print ""
        ...
        print "You find deep strength within yourself to keep going."
        print ""
        
    def _run(self, player):
        print "A large number of enemies catch up with you." 
        raw_input("Press enter to continue. ")
        print ""
        
        battle(player, constants.BattleEngineContext.STORY, self._wave4)

        print "You narrowly escape your pursuers!"
        print ""
